...
echo "Creating epics..."
create_epic "EP01" "Gateway & Telegram" "Telegram bot gateway with error handling and fast responses"
create_epic "EP02" "SurrealDB & Data Layer" "Database layer with persistence, typed access, and backups"
create_epic "EP03" "Identity Core" "User profiling, learning, memory, and personalization"
create_epic "EP04" "Intent Router" "Semantic routing for natural language classification"
create_epic "EP05" "Ollama / Local LLM (Tier 2)" "Local LLM integration for cost-effective processing"
create_epic "EP06" "Claude Integration (Tier 3)" "Cloud LLM integration for complex conversations"
create_epic "EP07" "Smart Reminders" "Natural language reminders with smart defaults"
create_epic "EP08" "Google Calendar" "Calendar integration for event management"
create_epic "EP09" "Expense Tracker" "Spending tracking with auto-categorization"
create_epic "EP10" "Personal CRM" "Contact management and relationship tracking"
create_epic "EP11" "Goal Tracker" "Goal setting and progress tracking"
create_epic "EP12" "Hardening & Open Source" "Production readiness and open source setup"
create_epic "EP13" "Growth & Monetization" "Scaling, monetization, and multi-channel support"

echo "Creating user stories..."

# EP01: Gateway & Telegram (3 stories)
create_issue "S-001" "EP01: Gateway & Telegram" "Basic Telegram bot with echo functionality" \
...
create_issue "S-002" "EP01: Gateway & Telegram" "Graceful error handling and auto-restart" \
...
create_issue "S-003" "EP01: Gateway & Telegram" "Fast response time (<2 seconds) for simple messages" \
...
create_issue "S-004" "EP02: SurrealDB & Data Layer" "SurrealDB Docker Compose setup" \
...
create_issue "S-005" "EP02: SurrealDB & Data Layer" "Typed data access layer for SurrealDB" \
...
create_issue "S-006" "EP02: SurrealDB & Data Layer" "Automated daily backups of SurrealDB" \
...
create_issue "S-007" "EP03: Identity Core — Onboarding" "Natural onboarding conversation" \
...
create_issue "S-008" "EP03: Identity Core — Onboarding" "Remember preferred language (NL/EN)" \
...
create_issue "S-009" "EP03: Identity Core — Onboarding" "Timezone awareness for all datetime operations" \
...
create_issue "S-010" "EP03: Identity Core — User Profile" "Build user profile over time" \
...
create_issue "S-011" "EP03: Identity Core — User Profile" "Profile summary query" \
...
create_issue "S-012" "EP03: Identity Core — User Profile" "Profile correction mechanism" \
...
create_issue "S-013" "EP03: Identity Core — Learning Loop" "Automatic fact extraction from conversations" \
...
create_issue "S-014" "EP03: Identity Core — Learning Loop" "Fact decay over time" \
...
create_issue "S-015" "EP03: Identity Core — Learning Loop" "Learn response preferences from user reactions" \
...
create_issue "S-016" "EP03: Identity Core — Episodic Memory" "Daily conversation compression into summaries" \
...
create_issue "S-017" "EP03: Identity Core — Monthly Check-in" "Monthly check-in for feedback" \
...
create_issue "S-018" "EP04: Intent Router" "Natural language interaction without slash commands" \
...
create_issue "S-019" "EP04: Intent Router" "Semantic Router with 10+ predefined routes" \
...
create_issue "S-020" "EP04: Intent Router" "Fallback to local LLM for ambiguous messages" \
...
create_issue "S-021" "EP04: Intent Router" "Usage pattern biased classification" \
...
create_issue "S-022" "EP05: Ollama / Local LLM (Tier 2)" "Ollama Docker setup with Qwen 3.5 0.8B" \
...
create_issue "S-023" "EP05: Ollama / Local LLM (Tier 2)" "Personalized system prompt from Identity Core" \
...
create_issue "S-024" "EP05: Ollama / Local LLM (Tier 2)" "Graceful fallback to Claude if Ollama is down" \
...
create_issue "S-025" "EP06: Claude Integration (Tier 3)" "Complex conversations handled by Claude" \
...
create_issue "S-026" "EP06: Claude Integration (Tier 3)" "API cost tracking per user" \
...
create_issue "S-027" "EP07: Smart Reminders" "Create reminders by natural language" \
...
create_issue "S-028" "EP07: Smart Reminders" "Smart default reminder timing based on context" \
...
create_issue "S-029" "EP07: Smart Reminders" "Snooze reminders with inline buttons or text" \
...
create_issue "S-030" "EP07: Smart Reminders" "Reminder escalation for ignored reminders" \
...
create_issue "S-031" "EP07: Smart Reminders" "Recurring reminders (daily, weekly, monthly)" \
...
create_issue "S-032" "EP08: Google Calendar" "Create calendar events by chatting" \
...
create_issue "S-033" "EP08: Google Calendar" "Calendar schedule overview" \
...
create_issue "S-034" "EP08: Google Calendar" "Daily morning briefing" \
...
create_issue "S-035" "EP08: Google Calendar" "Modify or cancel events by chatting" \
...
create_issue "S-036" "EP08: Google Calendar" "OAuth2 flow for Google Calendar via Telegram" \
...
create_issue "S-037" "EP09: Expense Tracker" "Log expenses by natural language" \
...
create_issue "S-038" "EP09: Expense Tracker" "Auto-categorization of known stores" \
...
create_issue "S-039" "EP09: Expense Tracker" "Weekly and monthly spending summaries" \
...
create_issue "S-040" "EP09: Expense Tracker" "Budget per category with alerts" \
...
create_issue "S-041" "EP10: Personal CRM" "Track people automatically from conversations" \
...
create_issue "S-042" "EP10: Personal CRM" "Query last contact with a person" \
...
create_issue "S-043" "EP10: Personal CRM" "Birthday reminders for contacts" \
...
create_issue "S-044" "EP10: Personal CRM" "Follow-up reminders for contacts" \
...
create_issue "S-045" "EP11: Goal Tracker" "Set annual goals with quarterly/monthly breakdown" \
...
create_issue "S-046" "EP11: Goal Tracker" "Weekly check-ins on goals" \
...
create_issue "S-047" "EP11: Goal Tracker" "Goals linked to calendar and expenses" \
...
create_issue "S-048" "EP12: Hardening & Open Source" "Configuration via environment variables" \
...
create_issue "S-049" "EP12: Hardening & Open Source" "One-command Docker Compose setup" \
...
create_issue "S-050" "EP12: Hardening & Open Source" "Comprehensive error handling and retry logic" \
...
create_issue "S-051" "EP12: Hardening & Open Source" "Usage analytics dashboard" \
...
create_issue "S-052" "EP13: Growth & Monetization" "Landing page at stuur.dev" \
...
create_issue "S-053" "EP13: Growth & Monetization" "Hosted version of Stuur" \
...
create_issue "S-054" "EP13: Growth & Monetization" "WhatsApp support in addition to Telegram" \
...
create_issue "S-055" "EP13: Growth & Monetization" "Plugin system for custom action executors" \
...
echo "Done! Created 13 epics and 55 user stories in $ISSUES_DIR/"